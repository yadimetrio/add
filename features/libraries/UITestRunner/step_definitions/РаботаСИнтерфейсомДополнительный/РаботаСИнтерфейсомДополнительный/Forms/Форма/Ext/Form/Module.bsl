...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
    ...
    Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТекущаяФормаНеМодифицирована()","ТекущаяФормаНеМодифицирована","И текущая форма не модифицирована","","UI.Формы.Проверка состояния формы");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ТекущаяФормаМодифицирована()","ТекущаяФормаМодифицирована","Тогда текущая форма модифицирована","","UI.Формы.Проверка состояния формы");
...
Процедура ОткрылосьОкноПредупрежденияСЗаголовкомИТекстом(Заголовок, ПроверяемыйТекст) Экспорт
	Ванесса.Шаг("Тогда открылось окно '" + Заголовок + "'");

	НайденныйТекстПредупреждения = Ванесса.ПолучитьТекстПредупреждения();
	НашлиТекст = Ванесса.СтрокаСоответствуетШаблону(НайденныйТекстПредупреждения, ПроверяемыйТекст);
	Если Не НашлиТекст Тогда
		СтрокаОшибки = Ванесса.СтрШаблон_("Ожидаемый текст предупреждения не совпадает с полученным
		|  Ожидали: %1
		|  Получили: %2
		|", ПроверяемыйТекст, НайденныйТекстПредупреждения);
