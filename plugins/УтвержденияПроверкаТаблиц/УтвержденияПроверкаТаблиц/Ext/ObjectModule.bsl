...
Функция СравнитьЗначенияТаблиц(ТаблицаОжиданий, ТаблицаРезультатов, Различия, ДопПараметры)
	...
	Для Индекс = 0 По ГраницаСтрок Цикл
		...
		Для Каждого Колонка Из Колонки Цикл
			...
			Если ДопПараметры.Свойство("УнифицироватьПереносыСтрок") Тогда
				ОжидаемоеЗначение  = УнифицироватьПереносыСтрок(ОжидаемоеЗначение);
				ЗначениеРезультата = УнифицироватьПереносыСтрок(ЗначениеРезультата);
			КонецЕсли; 
...
Функция УнифицироватьПереносыСтрок(Строка)

	Результат = СтрЗаменить(Строка, Символы.ВК + Символы.ПС, Символы.ПС);
